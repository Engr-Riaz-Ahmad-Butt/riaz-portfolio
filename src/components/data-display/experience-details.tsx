...
const ExperienceDetails = ({
  ...
  return (
    ...
    >
      {/* node */}
      <div className="absolute left-8 flex h-4 w-4 -translate-x-1/2 items-center justify-center rounded-full border-2 border-blue-500 bg-white ring-4 ring-blue-500/10 dark:bg-gray-900 md:left-1/2">
         <div className="h-1.5 w-1.5 rounded-full bg-blue-500 transition-transform group-hover:scale-150" />
      </div>

      {/* card container */}
      <div className="ml-16 flex-1 md:ml-0 md:flex-none md:w-[45%] block pt-8 md:pt-0">
        <article
        ...
        >
          ...
          <div className="relative p-6">
            <div className="mb-5 flex items-start gap-4">
              <div
                className={`flex h-14 w-14 shrink-0 items-center justify-center rounded-2xl border p-2 backdrop-blur ${
              ...
              <div className="min-w-0 flex-1">
                ...
                <h3 className="mt-1 text-2xl font-semibold leading-tight">{position}</h3>
                <div className="mt-3 inline-flex rounded-full border border-blue-300 bg-blue-50 px-3 py-1 text-xs font-semibold text-blue-700 shadow-sm dark:border-blue-300/60 dark:bg-blue-950/90 dark:text-white">
                  {dateStr}
                </div>
              </div>
            </div>
            ...
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="mt-6 inline-flex items-center text-sm font-medium text-blue-700 transition hover:text-blue-900 dark:text-blue-300 dark:hover:text-blue-200"
            >
              Visit company
            </a>
          </div>
